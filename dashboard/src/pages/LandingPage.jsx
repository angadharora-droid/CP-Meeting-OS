...
function makeStyles(C) {
  return {
    ...
    sub: {
      ...
      maxWidth: 400, fontWeight: 400, marginBottom: 24,
    },
    sectionRow: { display: "flex", alignItems: "center", gap: 14, marginBottom: 16 },
    sectionLabel: {
    ...
    cardBody: { display: "flex", alignItems: "flex-start", gap: 14, flex: 1, marginBottom: 14 },
    ...
    cardFoot: { paddingTop: 12, borderTop: `0.5px solid ${C.vfaint}`, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 },
