...
const APPS = [
  ...
  },
  {
    ...
    section: "hr",
    short: "HR",
    label: "Recruitment & Position Control",
    desc: "Manage recruitment and position control — sanctioned positions, open requisitions, and hiring status.",
    href: "https://hr.centrepointgroup.in/",
    accent: "#4361EE",
    accentRgb: "67,97,238",
  ...
  },
  {
    ...
    section: "hr",
    short: "IP",
    label: "Interviewer Platform",
    desc: "Run candidate interviews — schedules, evaluations, and interviewer feedback in one place.",
    href: "https://interview.centrepointgroup.in/",
    accent: "#3A6FE0",
  ...
  },
  {
    ...
    short: "CR",
    label: "Careers",
    desc: "Careers at Centre Point — current openings and candidate applications across the group.",
    href: "https://careers.centrepointgroup.in/",
    accent: "#2F7FD8",
  ...
  },
  {
    ...
    section: "executive",
    short: "ES",
    label: "Executive Scheduler",
    desc: "Plan and manage executive calendars — appointments, schedules, and availability at a glance.",
    href: "https://executivescheduler.centrepointgroup.in/",
    accent: "#2589C9",
