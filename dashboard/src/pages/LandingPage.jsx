...
function makeStyles(C, m = false) {
  return {
    ...
    main: {
      flex: 1, minHeight: 0, padding: m ? "20px 16px" : "40px 28px 32px",
      maxWidth: 1120, margin: "0 auto",
      width: "100%", boxSizing: "border-box",
      overflow: "hidden", display: "flex", flexDirection: "column",
      justifyContent: m ? "center" : "flex-start",
    },
    hero: { display: "flex", alignItems: "center", marginBottom: m ? 18 : 28 },
    heroLeft: { maxWidth: 520 },
    eyebrowRow: { display: "flex", alignItems: "center", gap: 14, marginBottom: m ? 12 : 20 },
    eyebrowChip: {
    ...
    headline: {
      ...
      fontSize: m ? "clamp(30px, 9vw, 42px)" : "clamp(36px, 6vw, 68px)",
      fontWeight: 800, lineHeight: 1.08,
      letterSpacing: "-0.03em", marginBottom: m ? 14 : 24,
    },
    ...
    sub: {
      ...
      maxWidth: 400, fontWeight: 400, marginBottom: m ? 0 : 24,
    },
    sectionRow: { display: "flex", alignItems: "center", gap: 14, marginBottom: m ? 12 : 16 },
    sectionLabel: {
    ...
    card: {
      ...
      padding: m ? "14px 16px 12px" : "18px 20px 16px", position: "relative",
    ...
    cardHead: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: m ? 10 : 14 },
    indexBadge: {
      fontFamily: FONTS.mono, fontSize: 10, fontWeight: 700, letterSpacing: "0.08em",
      padding: "3px 8px", borderRadius: 5, border: "0.5px solid", background: C.badgeBg,
    },
    livePill: {
    ...
    cardBody: { display: "flex", alignItems: "flex-start", gap: 14, flex: 1, marginBottom: m ? 10 : 14 },
